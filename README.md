...
![poi-parser](https://github.com/c0ying/hugeExcelUtil/blob/master/doc/img/poi-parser.png)

1. alibaba EasyExcel 解析Excel使用Sax流式处理，使用内存很小且处理速度非常快

![sax-parser](https://github.com/c0ying/hugeExcelUtil/blob/master/doc/img/sax-parser.png)
